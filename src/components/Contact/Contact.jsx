...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://elitebackend-82n8.onrender.com/api/contact", {
        method: "POST",
        headers: {
  ...
  return (
    <div className={`relative flex items-top justify-center min-h-[700px] ${darkMode ? "light-dark" : "bg-white"} sm:items-center sm:pt-0`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-6 mr-2 bg-gray-100 sm:rounded-lg">
              ...
              <div className="flex items-center mt-8 text-gray-600">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">GKP UNIVERSITY, GKP</div>
              </div>
              ...
              <div className="flex items-center mt-4 text-gray-600">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">+91 8887838118</div>
              </div>
              ...
              <div className="flex items-center mt-2 text-gray-600">
                ...
                <div className="ml-4 text-md tracking-wide font-semibold w-40">ag21210909@gmail.com</div>
              </div>
            </div>
